...
public class DadosCadastrais extends AbstractInfoCnpj {
    ...
    public static DadosCadastrais parse(final byte[] source) throws ParseException {
        return new DadosCadastrais(
                ...
                new String(copyOfRange(source, 168, 223)).trim(),
                new String(copyOfRange(source, 223, 225)).trim(),
                parseDate(copyOfRange(source, 225, 233)),
                new String(copyOfRange(source, 233, 235)).trim(),
                new String(copyOfRange(source, 235, 290)).trim(),
                new String(copyOfRange(source, 290, 293)).trim(),
                new String(copyOfRange(source, 293, 363)).trim(),
                new String(copyOfRange(source, 363, 367)).trim(),
                parseDate(copyOfRange(source, 367, 375)),
                new String(copyOfRange(source, 375, 382)).trim(),
                new String(copyOfRange(source, 382, 402)).trim(),
                new String(copyOfRange(source, 402, 462)).trim(),
                new String(copyOfRange(source, 462, 468)).trim(),
                new String(copyOfRange(source, 468, 624)).trim(),
                new String(copyOfRange(source, 624, 674)).trim(),
                new String(copyOfRange(source, 674, 682)).trim(),
                new String(copyOfRange(source, 682, 684)).trim(),
                new String(copyOfRange(source, 684, 688)).trim(),
                new String(copyOfRange(source, 688, 738)).trim(),
                new String(copyOfRange(source, 738, 750)).trim(),
                new String(copyOfRange(source, 750, 754)).trim(),
                new String(copyOfRange(source, 754, 762)).trim(),
                new String(copyOfRange(source, 762, 774)).trim(),
                new String(copyOfRange(source, 774, 778)).trim(),
                new String(copyOfRange(source, 778, 786)).trim(),
                new String(copyOfRange(source, 786, 798)).trim(),
                new String(copyOfRange(source, 798, 802)).trim(),
                new String(copyOfRange(source, 802, 810)).trim(),
                new String(copyOfRange(source, 810, 925)).trim(),
                new String(copyOfRange(source, 925, 927)).trim(),
                new String(copyOfRange(source, 927, 941)).trim(),
                new String(copyOfRange(source, 941, 943)).trim(),
                ...
                new String(copyOfRange(source, 961, 984)).trim(),
                parseDate(copyOfRange(source, 984, 992)),
                new String(copyOfRange(source, 992, 1199)).trim(),
